...
export class Lead {
  ...
  @OneToMany(
    () => Sale,
    sales => sales.overallLead120,
  )
  overallSales120: Sale[];

  @OneToMany(
    () => Sale,
    sales => sales.franchiseLead120,
  )
  franchiseSales120: Sale[];

  @OneToMany(
    () => Sale,
    sales => sales.overallLead360,
  )
  overallSales360: Sale[];

  @OneToMany(
    () => Sale,
    sales => sales.franchiseLead360,
  )
  franchiseSales360: Sale[];

  @OneToMany(
    () => Sale,
    sales => sales.overallLeadXTime,
  )
  overallSalesXTime: Sale[];

  @OneToMany(
    () => Sale,
    sales => sales.franchiseLeadXTime,
  )
  franchiseSalesXTime: Sale[];
}
